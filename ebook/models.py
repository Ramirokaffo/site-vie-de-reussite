...
class EbookModel(models.Model):
    ...
    description = HTMLField(max_length=200000, verbose_name="description du livre")
    ...
    illustration_video = models.CharField(blank=True, null=True, max_length=1000, verbose_name="Lien vers la vidéo d'illustration")
